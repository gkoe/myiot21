...
const char *mac = "c4:7c:8d:66:cd:b3";
...
bool connectToServer()
{
  ...
  BLEAddress bleAddress = BLEAddress(std::string(mac));
  pClient->connect(bleAddress); // if you pass BLEAdvertisedDevice instead of address, it will be recognized type of peer device address (public or private)
