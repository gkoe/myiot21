...
float Dht::getHumidity() { return _humidity; }
float Dht::getTemperature() { return _temperature; }

// == error handler ===============================================

void Dht::errorHandler(int errorCode)
{
    switch (errorCode)
    {
