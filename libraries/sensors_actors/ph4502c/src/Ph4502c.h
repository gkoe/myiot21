...
class Ph4502c : public IotSensor
{
public:
    Ph4502c(adc1_channel_t adcChannel,  const char* thingName, const char* name, const char* unit, float threshold, float minValue = 0.0, float maxValue = 30.0, bool getAverageValue = true);
